...
function mesesDelAño(array) {
  ...
  // Tu código:
  let mesesPorEncontrar = ['Enero', 'Marzo', 'Noviembre'];
  let mesesEncontrados = [];
  for (let i = 0; i < array.length; i++) {
    if ( mesesPorEncontrar.includes(array[i]) ) { mesesEncontrados.push(array[i]); }
  }
  return (mesesEncontrados.includes('Enero') && mesesEncontrados.includes('Marzo') && mesesEncontrados.includes('Noviembre')) ? mesesEncontrados : "No se encontraron los meses pedidos";
}
